...
> **Mapping principle:** Named actors are used where public evidence supports them; otherwise the chain remains at category level.
...
The company / operational name may still refer to **Ninh Thuận**, while current administrative geography has changed after provincial restructuring. The operational name is retained here; current administrative geography may differ after provincial restructuring.
...
Khanh An is included as part of the current processing network, while selected-product routing through this plant is not established.
...
| P1 | Processing | Minh Phu Cà Mau | Cà Mau area | Raw shrimp | Raw IQF frozen shrimp | Frozen storage | Government-hosted process document |
| P2 | Processing | Minh Phu Hau Giang | Mekong Delta | Raw shrimp | Raw IQF Vannamei PD | Frozen storage / export | Commercial shipment evidence |
